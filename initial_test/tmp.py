...
import datetime
from torch import device, zeros, no_grad, save
...
class RNNModel(nn.Module):
    ...
    def forward(self, x):
        ...
        h0 = zeros(self.layer_dim, x.size(0), self.hidden_dim).requires_grad_()
...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        c0 = zeros(self.layer_dim, x.size(0), self.hidden_dim).requires_grad_()
